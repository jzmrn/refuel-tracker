...
export const en: TranslationStructure = {
  ...
  kilometers: {
    ...
    editKilometer: "Edit Kilometer Entry",
    allEntries: "All Distance Entries",
    ...
    entryUpdated: "Kilometer entry updated successfully!",
    entryNotFound: "Kilometer entry not found",
  ...
  fuelPrices: {
    ...
    cityMinChars: "Type at least 2 characters",
    ...
    coordinatesHint:
      "Coordinates are filled automatically from the selected city",
    ...
    priceIncreased: "Price Increases",
    priceDecreased: "Price Decreases",
  ...
  statistics: {
    ...
    priceIncreasedByPlace: "Price Increases by Station and Day",
    priceDecreasedByPlace: "Price Decreases by Station and Day",
    ...
    priceIncreasedByBrand: "Price Increases by Station and Day",
    priceDecreasedByBrand: "Price Decreases by Station and Day",
    ...
    priceIncreasedByStation: "Price Increases per Day",
    priceDecreasedByStation: "Price Decreases per Day",
    avgDailyPriceChanges: "Avg. Daily Price Changes",
    avgDailyUniquePrices: "Avg. Daily Unique Prices",
    variance: "Variance (Std. Dev.)",
    back: "Back",
    stationStatsTitle: "Station Statistics",
    dailyPriceAllFuels: "Daily Average Price (All Fuel Types)",
    stationVsPlaceVsBrand: "Station vs Place vs Brand",
    stationLegendSuffix: "Station",
    cityLegendSuffix: "City",
    brandLegendSuffix: "Brand",
    viewStationStats: "View Statistics",
    last30Days: "30 Days",
    last60Days: "60 Days",
    last90Days: "90 Days",
    dataSource: {
      ...
      noFavourites: "No favourites set. Add stations to favourites first.",
      stations: "Stations",
      brands: "Brands",
      places: "Places",
    },
