...
export const de: TranslationStructure = {
  ...
  refuels: {
    ...
    noDaysBetweenDataAvailable: "Nicht genügend Daten verfügbar",
    addMoreRefuelEntriesToSeeDaysBetweenTrends:
      "Mindestens zwei Tankeinträge hinzufügen, um Tage zwischen Tankungen zu sehen",
    days: "Tage",
    daysUnit: "Tage",
    minDaysBetween: "Min. Tage",
    maxDaysBetween: "Max. Tage",
    avgDaysBetween: "Ø Tage",
    medianDaysBetween: "Median Tage",
  ...
  kilometers: {
    ...
    editKilometer: "Kilometerstand bearbeiten",
    allEntries: "Alle Kilometereinträge",
    ...
    entryUpdated: "Kilometereintrag erfolgreich aktualisiert!",
    entryNotFound: "Kilometereintrag nicht gefunden",
  ...
  fuelPrices: {
    ...
    radiusKm: "Radius (km)",
    city: "Ort",
    cityPlaceholder: "Ort suchen...",
    cityMinChars: "Mindestens 2 Zeichen eingeben",
    cityRequired: "Bitte einen Ort aus der Liste auswählen",
    searchByCity: "Suche nach Ort",
    searchByCoordinates: "Suche nach Koordinaten",
    noCitiesFound: "Keine passenden Orte gefunden",
    coordinatesHint:
      "Die Koordinaten werden automatisch aus dem gewählten Ort übernommen",
    ...
    priceIncreased: "Preiserhöhungen",
    priceDecreased: "Preissenkungen",
  ...
  statistics: {
    ...
    priceIncreasedByPlace: "Preiserhöhungen pro Tankstelle und Tag",
    priceDecreasedByPlace: "Preissenkungen pro Tankstelle und Tag",
    ...
    priceIncreasedByBrand: "Preiserhöhungen pro Tankstelle und Tag",
    priceDecreasedByBrand: "Preissenkungen pro Tankstelle und Tag",
    ...
    priceIncreasedByStation: "Preiserhöhungen pro Tag",
    priceDecreasedByStation: "Preissenkungen pro Tag",
    ...
    back: "Zurück",
    stationStatsTitle: "Tankstellenstatistik",
    dailyPriceAllFuels: "Täglicher Durchschnittspreis (Alle Kraftstoffarten)",
    stationVsPlaceVsBrand: "Tankstelle vs Ort vs Marke",
    stationLegendSuffix: "Tankstelle",
    cityLegendSuffix: "Stadt",
    brandLegendSuffix: "Marke",
    viewStationStats: "Statistiken anzeigen",
    last30Days: "30 Tage",
    last60Days: "60 Tage",
    last90Days: "90 Tage",
    dataSource: {
