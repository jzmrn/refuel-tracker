...
export default function StationDetails() {
  ...
  return (
    <>
      <style jsx>{`
        .page-container {
          animation: ${isVisible ? "fadeSlideIn" : "fadeSlideOut"} 0.3s ease-out;
      ...
      <div className="page-container">
        <div className="sticky top-0 bg-white dark:bg-gray-900 border-b border-gray-200 dark:border-gray-700 z-10 px-4 py-4 md:px-6 -mx-1 -mt-1 md:-mx-6 md:-mt-6 mb-4 md:mb-6 flex items-center gap-4">
          <button
            onClick={handleBack}
          ...
          <h1 className="heading-2">{t.fuelPrices.stationDetails}</h1>
        </div>
